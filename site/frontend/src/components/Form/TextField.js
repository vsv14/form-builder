...
function TextField(props) {
    return (
        <div className={props.className} style={{...style.textfield}}>
            ...
            <input style={{...style.input}} disabled={props.awnser || false} name={props.name} type='text' {...props.propsField} defaultValue={props.awnser||props.propsField.defaultValue}/>                   
        </div>
    )
}
